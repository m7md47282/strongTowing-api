...
export class SettingsComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    this.settingsForm = this.fb.group({
      ...
      pricingFreeMiles: [0, [Validators.required, Validators.min(0)]],
  ...
  private buildUpdateFromCurrent(): UpdateSystemSettingsRequest {
    ...
    return {
      ...
      pricingFreeMiles: c.pricingFreeMiles ?? 0,
      ...
      .subscribe({
        next: (settings) => {
          ...
          this.settingsForm.patchValue({
            ...
            pricingFreeMiles: settings.pricingFreeMiles ?? 0,
  ...
  saveSettings(): void {
    ...
    const payload: UpdateSystemSettingsRequest = {
      ...
      pricingFreeMiles: Number(formValue.pricingFreeMiles ?? 0),
